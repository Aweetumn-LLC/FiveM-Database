...
const Legal = () => {
  const canonical = typeof window !== "undefined" ? window.location.href : "https://fivemdb.online/legal";
  return (
          ...
          <div className="space-y-6">
            ...
            <Card className="glass-card border-0">
              <CardContent className="p-6">
                ...
                <p className="text-white/70 leading-relaxed">
                  For legal inquiries, takedown requests, or corrections, contact: <span className="text-teal-400 ml-1">autumn@fivemdb.online</span>
                </p>
