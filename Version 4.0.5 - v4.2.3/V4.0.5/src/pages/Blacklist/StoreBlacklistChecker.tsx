...
const StoreBlacklistChecker = () => {
  ...
  const storeCheckerJsonLd = {
    ...
    url: "https://fivemdb.online/store-blacklist-checker",
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4 tracking-tight">
              Store/Hosting Blacklist Checker
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Verify FiveM stores and hosting providers for content violations and unauthorized sales
            </p>
          </div>
