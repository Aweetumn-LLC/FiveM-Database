...
const HowWeUseYourData = () => {
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>How We Use Your Data | FiveM DB</title>
        <meta name="description" content="How FiveM DB uses anonymized analytics and data to improve services while protecting user privacy." />
        <link rel="canonical" href="https://fivemdb.net/how-we-use-your-data" />
      </Helmet>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-lg p-4 mt-4">
                    <p className="text-indigo-200 text-sm">
                      ...
                      <span className="text-indigo-400 ml-1">legal@nexoradata.ltd</span>
