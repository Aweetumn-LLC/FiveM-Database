...
export default function PartnersManager() {
    ...
    try {
      ...
      if (editingPartner) {
        ...
        await logAdminAction(
          ...
          'partners',
          formData.name,
          `Updated partner "${formData.name}" (${formData.partner_type})`
        );
        ...
        await logAdminAction(
          ...
          'partners',
          formData.name,
          `Added partner "${formData.name}" (${formData.partner_type})`
        );
  ...
  const handleDelete = async (partnerId: string) => {
    ...
    try {
      ...
      // Find the deleted partner for logging
      ...
      await logAdminAction(
        ...
        'deleted',
        'partners',
        deletedPartner?.name || 'Unknown',
        `Deleted partner "${deletedPartner?.name}" (${deletedPartner?.partner_type})`
      );
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            {showAddForm && hasPermission('edit_partners') && (
              <Card>
                <CardHeader>
