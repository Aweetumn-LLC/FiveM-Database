...
const TermsOfService = () => {
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Terms of Service | FiveM DB</title>
        <meta name="description" content="FiveM DB Terms of Service: user obligations, acceptable use, and legal agreements for using our platform." />
        <link rel="canonical" href="https://fivemdb.net/terms-of-service" />
      </Helmet>
