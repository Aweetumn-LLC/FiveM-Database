...
const Reports = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>FiveM Database - CFX Reports & Server Violation Database</title>
        <meta name="description" content="Access comprehensive reports on FiveM server violations, TOS/COC infractions, and CFX compliance issues. Browse our database of documented violations and server statuses." />
        <meta name="keywords" content="FiveM reports, CFX violations, server blacklist reports, TOS violations, COC infractions, FiveM compliance reports, server status, violation database" />
        <link rel="canonical" href="https://fivemdb.net/reports" />
        <meta property="og:title" content="FiveM Database - CFX Reports & Server Violation Database" />
        <meta property="og:description" content="Access comprehensive reports on FiveM server violations, TOS/COC infractions, and CFX compliance issues." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fivemdb.net/reports" />
        <meta property="og:image" content="https://cdn.velocitynet.work/5DB/Data/5DBEmbed.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FiveM Database - CFX Reports & Server Violation Database" />
        <meta name="twitter:description" content="Access comprehensive reports on FiveM server violations, TOS/COC infractions, and CFX compliance issues." />
