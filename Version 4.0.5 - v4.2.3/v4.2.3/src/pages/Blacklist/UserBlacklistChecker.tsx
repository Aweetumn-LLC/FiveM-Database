  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/20">
      <Helmet>
        ...
        <link rel="canonical" href="https://fivemdb.online/user-blacklist-checker" />
        ...
        <meta property="og:url" content="https://fivemdb.online/user-blacklist-checker" />
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Advanced user reputation verification and violation history analysis
            </p>
          </div>
