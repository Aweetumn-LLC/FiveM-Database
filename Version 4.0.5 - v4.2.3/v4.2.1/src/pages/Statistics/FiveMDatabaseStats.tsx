...
const FiveMDatabaseStats = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>FiveM Database Statistics | Platform Usage & Community Metrics</title>
        <meta name="description" content="Explore comprehensive FiveM Database statistics including platform usage, blacklist entries, community protection checks, and compliance rates. Real-time metrics and analytics." />
        <meta name="keywords" content="FiveM Database statistics, platform metrics, blacklist statistics, FiveM analytics, compliance statistics, community metrics, usage data" />
        <link rel="canonical" href="https://fivemdb.net/statistics/fivem-database-stats" />
        <meta property="og:title" content="FiveM Database Statistics | Platform Usage & Community Metrics" />
        <meta property="og:description" content="Explore comprehensive FiveM Database statistics including platform usage, blacklist entries, and community protection metrics." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fivemdb.net/statistics/fivem-database-stats" />
        <meta property="og:image" content="https://cdn.velocitynet.work/5DB/Data/5DBEmbed.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FiveM Database Statistics | Platform Metrics" />
        <meta name="twitter:description" content="Real-time FiveM Database statistics and analytics for platform usage and community protection." />
