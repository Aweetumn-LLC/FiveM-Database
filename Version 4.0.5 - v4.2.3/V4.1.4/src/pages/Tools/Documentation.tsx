...
const Documentation = () => {
  return (
    <div className="min-h-screen bg-black text-white flex items-start justify-center py-8">
      <Helmet>
        <title>FiveM Database Documentation - Complete Guide to FiveM Compliance Tools</title>
        <meta name="description" content="Comprehensive documentation for FiveM Database tools including resource checker, server verification, blacklist systems, API access, and community reporting features." />
        <meta name="keywords" content="FiveM DB documentation, resource checker guide, server checker tutorial, FiveM compliance tools, API documentation, community reports, blacklist tools, FiveM security guide" />
        <link rel="canonical" href="https://fivemdb.net/tool-info/documentation" />
        <meta property="og:title" content="FiveM Database Documentation - Complete Guide to FiveM Compliance Tools" />
        <meta property="og:description" content="Comprehensive documentation for FiveM Database tools including resource checker, server verification, blacklist systems, and community reporting features." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fivemdb.net/tool-info/documentation" />
        <meta property="og:image" content="https://cdn.velocitynet.work/5DB/Data/5DBEmbed.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FiveM Database Documentation - Complete Guide" />
        <meta name="twitter:description" content="Learn how to use FiveM Database tools for resource verification, server checking, and community protection." />
          ...
          <Card className="bg-gray-900 border-gray-700">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-1">
                  <li>
                    <a href="https://discord.fivemdb.net" target="_blank" rel="noopener noreferrer" 
