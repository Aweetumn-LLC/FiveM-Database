...
const ComplianceStatistics = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>FiveM Database - Compliance Statistics & TOS/COC Analytics</title>
        <meta name="description" content="Monitor FiveM Terms of Service and Code of Conduct compliance statistics. Track violation rates, clean results, and community safety metrics with real-time analytics dashboard." />
        <meta name="keywords" content="FiveM compliance statistics, TOS compliance analytics, COC violation rates, FiveM safety metrics, compliance dashboard, resource compliance stats, server compliance data" />
        <link rel="canonical" href="https://fivemdb.net/compliance-statistics" />
        <meta property="og:title" content="FiveM Database - Compliance Statistics & TOS/COC Analytics" />
        <meta property="og:description" content="Monitor FiveM Terms of Service and Code of Conduct compliance statistics with real-time analytics dashboard." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fivemdb.net/compliance-statistics" />
        <meta property="og:image" content="https://cdn.velocitynet.work/5DB/Data/5DBEmbed.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FiveM Database - Compliance Statistics Dashboard" />
        <meta name="twitter:description" content="Real-time FiveM TOS/COC compliance statistics and community safety metrics." />
