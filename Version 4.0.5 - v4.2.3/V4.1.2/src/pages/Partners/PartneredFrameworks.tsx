...
const PartneredFrameworks = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5">
      <Helmet>
        <title>FiveM Partnered Frameworks | FiveM DB</title>
        <meta name="description" content="Explore trusted FiveM development frameworks partnered with FiveM DB for robust server development." />
        <link rel="canonical" href="https://fivemdb.net/partnered-frameworks" />
      </Helmet>
