  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://fivemdb.online/tool-info/blacklist-system" />
        ...
        <meta property="og:url" content="https://fivemdb.online/tool-info/blacklist-system" />
              ...
              <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-6 rounded-lg border border-primary/20">
                <p className="mb-4">
                  ...
                  <Button variant="link" className="p-0 h-auto text-primary" asChild>
                    <a href="https://insider.fivemdb.net" target="_blank" rel="noopener noreferrer">
