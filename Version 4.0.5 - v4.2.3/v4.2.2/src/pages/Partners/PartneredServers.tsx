...
const PartneredServers = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5">
      <Helmet>
        <title>FiveM Partnered Servers | FiveM DB</title>
        <meta name="description" content="Featured FiveM partner servers trusted by FiveM DB for quality, roleplay, and community engagement." />
        <link rel="canonical" href="https://fivemdb.online/partnered-servers" />
      </Helmet>
