...
const About = () => {
  return (
    <Layout>
      <Helmet>
        <title>About FiveM Database - Community-Driven FiveM Compliance & Security</title>
        <meta name="description" content="Learn about FiveM Database, a community-driven initiative dedicated to documenting violations in the FiveM ecosystem. Discover our mission, team, and impact on FiveM compliance." />
        <meta name="keywords" content="FiveM Database about, FiveM community, TOS violations, CFX reporting, FiveM compliance team, platform accountability, community reporting" />
        <link rel="canonical" href="https://fivemdb.net/about" />
        <meta property="og:title" content="About FiveM Database - Community-Driven FiveM Compliance & Security" />
        <meta property="og:description" content="Learn about FiveM Database, a community-driven initiative dedicated to documenting violations in the FiveM ecosystem." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fivemdb.net/about" />
        <meta property="og:image" content="https://cdn.velocitynet.work/5DB/Data/5DBEmbed.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About FiveM Database - Community-Driven FiveM Compliance & Security" />
        <meta name="twitter:description" content="Learn about FiveM Database, a community-driven initiative dedicated to documenting violations in the FiveM ecosystem." />
