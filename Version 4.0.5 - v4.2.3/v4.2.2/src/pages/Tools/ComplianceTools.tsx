...
export default function ComplianceTools() {
  const complianceToolsJsonLd = {
    ...
    url: "https://fivemdb.online/tool-info/compliance-tools",
    about: {
      "@type": "Thing",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://fivemdb.online/tool-info/compliance-tools" />
        ...
        <meta property="og:url" content="https://fivemdb.online/tool-info/compliance-tools" />
