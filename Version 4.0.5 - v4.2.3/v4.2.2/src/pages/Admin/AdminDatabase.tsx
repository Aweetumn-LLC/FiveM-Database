...
import { Shield, Key, Users, Server, Store, MessageCircle, AlertTriangle, Link, Clock, Flag } from "lucide-react";
...
import FalsePositiveManagement from "@/components/FalsePositiveManagement";
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 p-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              <TabsList className="grid w-full grid-cols-5 lg:w-[1000px] bg-white/5 border border-white/10">
                ...
                <TabsTrigger value="false-positives" className="data-[state=active]:bg-orange-500/20 data-[state=active]:text-orange-400">
