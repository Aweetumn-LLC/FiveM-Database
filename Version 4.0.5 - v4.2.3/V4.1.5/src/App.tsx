...
const SealOfApprovalList = lazy(() => import("./pages/SealOfApprovalList"));
                ...
                <MaintenanceWrapper>
                  ...
                  <Suspense fallback={<PageLoader />}>
                    <Routes>
                      ...
                      <Route path="/seal-of-approval" element={<Layout title="FiveM DB - Seal of Approval | Verified Creators" description="Browse all verified FiveM creators who have earned the Seal of Approval from FiveM Database."><Suspense fallback={<PageLoader />}><SealOfApprovalList /></Suspense></Layout>} />
                      <Route path="/seal-of-approval/:creator_name" element={<Layout title="FiveM DB - Creator Seal of Approval" description="Verified creator with seal of approval from FiveM Database."><Suspense fallback={<PageLoader />}><SealOfApproval /></Suspense></Layout>} />
