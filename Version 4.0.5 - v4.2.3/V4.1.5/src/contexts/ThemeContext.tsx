...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    const anniversary = themes.find(t => t.id === 'anniversary') || themes[0];
    setCurrentTheme(anniversary);
    localStorage.setItem('selected-theme', 'anniversary');
