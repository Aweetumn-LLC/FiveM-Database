...
const DataPolicy = () => {
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Data Policy | FiveM DB</title>
        <meta name="description" content="Learn how FiveM DB collects, uses, and protects your data, including evidence submissions and analytics." />
        <link rel="canonical" href="https://fivemdb.net/data-policy" />
      </Helmet>
