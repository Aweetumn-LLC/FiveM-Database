...
const Documentation = () => {
  return (
    <div className="min-h-screen bg-black text-white flex items-start justify-center py-8">
      <Helmet>
        <title>Documentation | FiveM DB</title>
        <meta name="description" content="Complete guide to using FiveM DB tools: resource checker, server checker, reports, API, and community features." />
