...
const CreatorReleaseMarket = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ storeName: "", storeLink: "", resourceLink: "", resourcePrice: "" });
      setShowForm(false);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <link rel="canonical" href="https://fivemdb.net/creator-release-market" />
        ...
        <meta property="og:url" content="https://fivemdb.net/creator-release-market" />
