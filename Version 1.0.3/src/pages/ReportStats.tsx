...
// Import the reports data to maintain consistency
...
const ReportStats = () => {
  ...
  const [violationData, setViolationData] = useState<ViolationType[]>([]);
    ...
    // Un-used old Reports//month chart display
  // const monthlyData = [
  //   { month: "Jan", reports: 0 },
  //   { month: "Feb", reports: 0 },
  //   { month: "Mar", reports: 8 },
  ...
  useEffect(() => {
    try {
      ...
      // Prepare chart data 
      setChartData([
        { name: 'Open Reports', value: openReports, fill: '#bc7da0', percent: openPercent },
        { name: 'Closed Reports', value: closedReports, fill: '#a1266d', percent: closedPercent },
        { name: 'Resolved Reports', value: resolvedReports, fill: '#167a46', percent: resolvedPercent },
      ]);
