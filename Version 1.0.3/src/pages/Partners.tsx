...
// Recommended Creators Data
const RECOMMENDED_CREATORS_DATA = [
  {
    id: 1,
    name: "Quasar",
    description: "Quasar Store",
  ...
  },
  {
    ...
    description: "RTX Development Store",
  ...
  },
  {
    id: 3,
    name: "Dynyx Scripts",
    description: "Dynyx Scripts Store",
...
const Partners = () => {
  ...
  const [selectedRecommendedCreator, setSelectedRecommendedCreator] = useState(RECOMMENDED_CREATORS_DATA[0]);
          ...
          <div className="relative">
            ...
            <Tabs defaultValue="recommended" className="w-full">
              <TabsList className="w-full justify-start mb-8 bg-white/5">
                <TabsTrigger value="recommended" className="flex items-center gap-2 data-[state=active]:text-gradient">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-1">
                    <div className="glass-card p-6 rounded-xl sticky top-24">
                      <h3 className="font-display text-xl mb-4">Recommended Creators</h3>
                      <div className="space-y-4">
                        {RECOMMENDED_CREATORS_DATA.map(creator => (
                          <div 
                            key={creator.id}
                            className={`p-4 rounded-lg transition-all cursor-pointer ${
                              selectedRecommendedCreator.id === creator.id 
                                ? 'bg-white/10 shadow-lg' 
                                : 'hover:bg-white/5'
                            }`}
                            onClick={() => setSelectedRecommendedCreator(creator)}
                          >
                  ...
                  <div className="lg:col-span-2">
                    <div className="glass-card rounded-xl overflow-hidden">
                      <div className="h-48 overflow-hidden">
                        <img 
                          src={selectedRecommendedCreator.image} 
                          alt={selectedRecommendedCreator.name} 
                          className="w-full object-cover"
                        />
                      </div>
                      
                      <div className="p-6">
                        <h2 className="text-2xl font-display mb-2">{selectedRecommendedCreator.name}</h2>
                        <p className="text-white/80 mb-6">{selectedRecommendedCreator.description}</p>
                        
                        <div className="grid grid-cols-2 gap-4 mb-8">
                          <div>
                            <p className="text-sm text-white/50">Specialty</p>
                            <p className="font-medium">{selectedRecommendedCreator.specialty}</p>
                          </div>
                          <div>
                            <p className="text-sm text-white/50">Founded</p>
                            <p className="font-medium">{selectedRecommendedCreator.founded}</p>
                          </div>
                        </div>
                        ...
                        <div className="rounded-lg overflow-hidden border border-white/10 mb-6 bg-black/30">
                          <AspectRatio ratio={16/9}>
                            <iframe 
                              src={selectedRecommendedCreator.website} 
                              title={`${selectedRecommendedCreator.name} website`} 
                        ...
                        <Button variant="outline" className="flex items-center gap-2" asChild>
                          <a href={selectedRecommendedCreator.website} target="_blank" rel="noopener noreferrer">
