...
export const RECOMMENDED_CREATORS_DATA = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: "Carotto Studios offers advanced and customizable scripts to elevate your roleplay server experience.",
    website: "https://carotto-studios.com/",
    image: "https://cdn.laurelnwk.com/VelocityDriftNetwork/carotto.png", // IF YOU DONT OWN A CDN WE CAN COVER THIS IMAGE LINK
    specialty: "Scripts", // WHAT YOUR STORE DOSE
    founded: "25/04/2024",
    featured: true, // IGNORE THIS
    tags: ["QUALITY","PEFORMANCE","RESOURCES"] // CUSTOM CREATORS TAGS CAN BE HERE LIKE "CUSTOM SCRIPTS", "CUSTOM MLO" ETC, ETC
  },
];
