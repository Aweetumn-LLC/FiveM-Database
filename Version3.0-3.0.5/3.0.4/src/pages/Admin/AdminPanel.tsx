...
const AdminPanel = () => {
  const { user, login, logout, hasPermission, logActivity } = useAdminAuth();
  ...
  const addKeyword = async (tableName: string, keyword: string, setter: (value: string) => void) => {
    ...
    try {
      ...
      // Log the activity
      await logActivity('create', `Added keyword: "${keyword.trim()}" to ${tableName}`, {
        action: 'add',
        table: tableName,
  ...
  const deleteKeyword = async (tableName: string, id: string, keyword?: string) => {
    try {
      ...
      // Log the activity
      await logActivity('delete', `Deleted keyword from ${tableName}`, {
        action: 'delete',
        table: tableName,
        keyword_id: id,
        target_table: tableName,
  ...
  const updateSetting = async (settingKey: string, value: any) => {
    try {
      ...
      // Log the activity
      await logActivity('update', `Updated setting: ${settingKey}`, {
        setting_key: settingKey,
        new_value: value,
        target_table: 'website_settings'
      });
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white/5 border-white/10 focus:border-orange-400/50 focus:ring-orange-400/20 text-white"
                      disabled={loading}
                    />
                  </div>
    ...
    <div className="min-h-screen" style={{ background: 'var(--theme-background)' }}>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <Tabs value={activeSection} onValueChange={setActiveSection} className="space-y-6">
          <TabsList className="grid w-full grid-cols-11 bg-white/5 p-1">
            ...
            {(hasPermission('view_analytics') || user?.username === 'Maintainer') && (
            ...
            {(hasPermission('view_blacklist') || user?.username === 'Maintainer') && (
            ...
            {(hasPermission('view_partners') || user?.username === 'Maintainer') && (
            ...
            {(hasPermission('import_export') || user?.username === 'Maintainer') && (
            ...
            {user?.username === 'Maintainer' && (
              <TabsTrigger value="maintainer" className="data-[state=active]:bg-indigo-500/20 data-[state=active]:text-indigo-400 flex items-center space-x-2">
                <Shield className="w-4 h-4" />
                <span>Maintainer</span>
              </TabsTrigger>
            )}
            {(hasPermission('view_logs') || user?.username === 'Maintainer') && (
              <TabsTrigger value="logs" className="data-[state=active]:bg-purple-500/20 data-[state=active]:text-purple-400 flex items-center space-x-2">
                <Activity className="w-4 h-4" />
                <span>Activity Logs</span>
              </TabsTrigger>
            )}
            {(hasPermission('manage_settings') || user?.username === 'Maintainer') && (
            ...
            <Tabs defaultValue="blacklist-links" className="space-y-6">
              ...
              <TabsContent value="ip-violation">
                <KeywordManagement 
                  ...
                  description="Keywords that trigger intellectual property violations"
                  icon={AlertTriangle}
                />
              </TabsContent>
              ...
              <TabsContent value="coc-violation">
                <KeywordManagement 
                  ...
                  description="Keywords that trigger code of conduct violations"
                  icon={XCircle}
                />
              </TabsContent>
              ...
              <TabsContent value="ip-bypass">
                <KeywordManagement 
                  ...
                  description="Keywords that bypass IP violation detection"
                  icon={CheckCircle2}
                />
              </TabsContent>
              ...
              <TabsContent value="coc-bypass">
                <KeywordManagement 
                  ...
                  description="Keywords that bypass COC violation detection"
                  icon={CheckCircle2}
                />
              </TabsContent>
              ...
              <TabsContent value="contextual">
                <KeywordManagement 
                  ...
                  description="Word combinations that trigger violations when found together"
                  icon={Activity}
                />
              </TabsContent>
            </Tabs>
          ...
          {/* Maintainer Section */}
          {user?.username === 'Maintainer' && (
            <TabsContent value="maintainer" className="space-y-6">
              <MaintainerManager />
            </TabsContent>
          )}
