...
const mockReports = [
...

  {
    ...
    description: "Grand Opening Came From Nothing NYC Serious RP | CUSTOM DRUGS | FREE GANGS | CUSTOM HOUSING | SREAMER FRIENDLY",
    status: "open" as const,
    type: "TOS//COC",
    reportDate: "2025",
    reportedBy: "Sophia",
...

  {
    ...
    description: "🌎💰GRAND OPENING🌎💰 FREE GANGS TRAPLOVERP🌎 | 💰  FRESH ECONOMY💰 | 🔫 #1 Serious RP🔫 |  E Girl/Stream Friendly🎥 | 👕 Custom Drip 👕 | 🔪 Gang Wars 🔪 | 👷 Active Staff 👷 | 💻 HIGH FPS 💻| 🌎",
    status: "open" as const,
    type: "TOS//COC",
    reportDate: "2025",
    reportedBy: "Sophia",
...

  {
    ...
    description: "Dirty South RP |🔥 GRAND OPENING 🔥| 🚔 NOW HIRING POLICE & EMS 🚑 | Streamer Friendly 🎥 | 🚗 Custom Cars & Jobs |🏢 Player-Owned Businesses | Active & Friendly Staff 👮",
    status: "open" as const,
    type: "TOS//COC",
    reportDate: "2025",
    reportedBy: "Sophia",
...

  {
    ...
    description: "Outside RP | True-to-Life Roleplay | Grand Opening | Active Community | Semi-Serious RP | Active Staff | Fresh Economy",
    status: "open" as const,
    type: "TOS//COC",
    reportDate: "2025",
    reportedBy: "Sophia",
...
const Reports = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "open":
        return <Badge className="bg-yellow-500/20 text-yellow-400"><Clock className="w-3 h-3 mr-1" />Open</Badge>;
      case "closed":
